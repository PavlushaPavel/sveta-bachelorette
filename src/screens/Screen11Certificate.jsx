...
export default function Screen11Certificate() {
  ...
  return (
    <div className="screen" style={{ justifyContent: 'center', minHeight: '100vh' }}>
      <div style={{ background: 'var(--color-surface)', borderRadius: 20, padding: 'var(--space-2xl) var(--space-xl)', border: '2px solid var(--color-gold)', textAlign: 'center', animation: 'fadeUp 400ms ease-out 200ms both' }}>
